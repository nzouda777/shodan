    ...
    <div class="pl-8">
       <RouterLink to="/artist">
            ...
            >
                ...
                >
                    <HeartOutline 
                    :class="isHover ? 'transition ease-in duration-150 bg-opacity-0' : 'transition ease-out duration-150 opacity-0' "
                        :size="23"
                    />
                </div>
                <div
                ...
                <img 
                 width="25"
                 class="absolute z-40 right-0 bottom-0 pb-3 contrast-[1.4] brightness-[1.1]"
                 src="/images/deezer-sound-icon.png" alt=""
                >
                <img :src="slide.url" class="rounded-md aspect-square" alt="">
            </div>
